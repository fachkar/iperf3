...
usage_long()
{
    fprintf ( stdout, usage_longstr, UDP_RATE / ( 1024 * 1024 ), DURATION, DEFAULT_TCP_BLKSIZE / 1024, DEFAULT_UDP_BLKSIZE / 1024 );
}
...
iperf_new_stream ( struct iperf_test* test, int s )
{
    int i;
    struct iperf_stream* sp;
    char template[] = "/mnt/sdcard/iperf3.XXXXXX";
